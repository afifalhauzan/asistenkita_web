    ...
    return (
        <div className="min-h-screen">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="flex flex-col md:flex-row gap-20 md:gap-12 lg:gap-8 xl:gap-20 items-center justify-start">
                    <div className="flex-1 w-full relative">
                        <div className="absolute -top-5">
                            <Img src="/orang_hero.png" alt="Trusted Person" width="300" height="450" className="w-140 h-120" />
                        </div>
                        {/* Background Circle */}
                        <div className="absolute inset-0opacity-20 transform scale-110"></div>
                        ...
                        <div className="flex z-10 rounded-3xl p-8 items-center justify-center">
                            ...
                            <div className="w-full h-96 rounded-2xl flex items-center justify-center relative overflow-hidden">
                                {/* Floating Elements */}
                                <div className="absolute top-35 right-20 bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg animate-pulse">
                                    Temukan bantuan
                                </div>
                                <div className="absolute bottom-12 left-12 bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg animate-pulse">
                                    Temukan bantuan
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-30 left-15 w-12 h-12 bg-yellow-300 rounded-full opacity-70 animate-pulse"></div>
                    </div>

                    {/* Right Side - Content */}
                    <div className="flex-1 space-y-10 max-w-2/5">
