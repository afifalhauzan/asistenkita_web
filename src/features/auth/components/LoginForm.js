...
export const LoginForm = ({ onSuccess, redirectTo = '/dashboard' }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setError('root', {
        type: 'manual',
        message: 'Terdapat error tak terduga, silakan coba lagi.'
      });
    } finally {
      setIsLoading(false);
    }
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full flex justify-between px-4 py-3 bg-gray-100 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 pr-4 ${
